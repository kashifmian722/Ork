...
CREATE TABLE `cms_page_translation` (
    ...
    CONSTRAINT `fk.cms_page_translation.cms_page_id` FOREIGN KEY (`cms_page_id`) REFERENCES `cms_page` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `cms_section` (
    ...
    CONSTRAINT `fk.cms_section.cms_page_id` FOREIGN KEY (`cms_page_id`) REFERENCES `cms_page` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `cms_block` (
    ...
    CONSTRAINT `fk.cms_block.cms_section_id` FOREIGN KEY (`cms_section_id`) REFERENCES `cms_section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `cms_slot` (
    ...
    CONSTRAINT `fk.cms_slot.cms_block_id` FOREIGN KEY (`cms_block_id`) REFERENCES `cms_block` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
